...
```bash
curl -L https://github.com/yogxx/ssclash/releases/download/v1.8.2.1-mod/luci-app-ssclash_1.8.2-r1_all.ipk -o /tmp/luci-app-ssclash_1.8.2-r1_all.ipk
opkg install /tmp/luci-app-ssclash_1.8.2-r1_all.ipk
rm /tmp/*.ipk
```
...
```bash
curl -L https://github.com/MetaCubeX/mihomo/releases/download/v1.19.10/mihomo-linux-amd64-compatible-v1.19.10.gz -o clash.gz
```

For **arm64** architecture:

```bash
curl -L https://github.com/MetaCubeX/mihomo/releases/download/v1.19.10/mihomo-linux-arm64-v1.19.10.gz -o clash.gz
```

For **mipsel_24kc** architecture:

```bash
curl -L https://github.com/MetaCubeX/mihomo/releases/download/v1.19.10/mihomo-linux-mipsle-softfloat-v1.19.10.gz -o clash.gz
```
