...
return view.extend({
	tinyFmConfigs: [
		{ path: '/www/tinyfilemanager', url: '/tinyfilemanager/tinyfilemanager.php?p=opt%2Fclash' },
		{ path: '/www/tinyfilemanager', url: '/tinyfilemanager/index.php?p=opt%2Fclash' },
		{ path: '/www/tinyfm', url: '/tinyfm/tinyfm.php?p=opt%2Fclash' },
		{ path: '/www/tinyfm', url: '/tinyfm/index.php?p=opt%2Fclash' }
	],
	...
	renderErrorMessage: function () {
		const m = new form.Map('clash', _('Clash File Manager | ERROR'), `
			${_('Manage Clash configuration and files in /opt/clash.')} 
			<a href="https://github.com/rizkikotet-dev/OpenWrt-nikki-Mod" target="_blank">
	...
	createErrorContent: function () {
		return E('div', {
			...
			E('h4', { style: 'color: #d9534f;' }, _('TinyFileManager not found or not installed.')),
			E('p', {}, _('Please install TinyFileManager using one of the following methods:')),
			E('ul', { style: 'padding-left: 20px;' }, [
				...
				E('li', {}, [
					...
					_(', then place it under /www and access it from Luci.')
				])
			])
		]);
	}
